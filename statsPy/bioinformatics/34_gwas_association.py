...
# %% [markdown]
# # Applied 34: Genotypes, GWAS, and statistical genetics
#
# **Curriculum link:** `stats.md` -> Topic 24, equations (24.1)-(24.9)
# **Core modules used:** 08 (multiplicity), 13 (logistic), 17 (PCs), 21, 22
#
# ## Dataset card
#
# | | |
...
MODULE_NAME = "34_gwas_association"
...
print("  textbook confounder (Module 22, fork structure).")
...
# # collider/selection structure of Module 22.
...
#
# **Next:** `35_proteomics_missing_values.py`
