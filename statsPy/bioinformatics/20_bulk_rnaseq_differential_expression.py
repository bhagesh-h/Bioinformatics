...
# %% [markdown]
# # Applied 20: Bulk RNA-seq differential expression
#
...
print("""
  ...
  # In R (Module 20's R twin does this directly):
...
# # pipeline is broken (Module 34, section 4).
#
...
#
# **Next:** `21_single_cell_pseudobulk.py`
