...
# %% [markdown]
# # Applied 25: Proteomics: missing values, batch structure, and inference
#
# **Curriculum link:** `stats.md` -> Topic 25, equations (25.1)-(25.4)
# **Core modules used:** 02, 05, 15 (missingness), 19 (batch), 33 (moderation)
#
# ## Dataset card
#
# | | |
...
MODULE_NAME = "25_proteomics_missing_values"
...
# # donor blocking did in Module 20 - free power from a term the design already
# # provides.
#
...
# # changes across this range, say so - that IS the result (Module 34).
...
#
# **Next:** `26_microbiome_compositional.py`
