...
# %% [markdown]
# # Applied 23: DNA methylation and epigenomics
#
# **Curriculum link:** `stats.md` -> Topic 23, equations (23.1)-(23.3)
# **Core modules used:** 02 (M-values), 13 (beta-binomial), 32 (mediation), 33
#
# ## Dataset card
#
# | | |
...
MODULE_NAME = "23_methylation_epigenomics"
...
#
# This is a **causal** decision (Module 32), not a statistical one.
...
print("  adjusting, decide the causal role (Module 32):")
