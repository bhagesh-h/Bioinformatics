...
# %% [markdown]
# # Applied 22: Flow / mass cytometry: differential abundance and state
#
# **Curriculum link:** `stats.md` -> Topic 22, equations (22.1)-(22.4)
# **Core modules used:** 01, 02 (arcsinh), 13 (offsets), 18 (clustering), 33
#
# ## Dataset card
#
# | | |
...
# # sensitivity analysis (Module 34). Higher k splits populations, which raises
...
#
# **Next:** `23_methylation_epigenomics.py`
