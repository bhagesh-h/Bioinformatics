...
# %% [markdown]
# # Applied 29: Functional enrichment and pathway statistics
#
# **Curriculum link:** `stats.md` -> Topic 29, equations (29.1)-(29.5)
# **Core modules used:** 01 (design effect!), 08 (multiplicity), 20
#
# ## Dataset card
#
# | | |
...
print("  `missMethyl::gometh` does for probe number (Module 23).")
...
# # surviving your expression filter (Module 20, section 2).
...
#
# **Next:** `30_networks_and_multiomics.py`
