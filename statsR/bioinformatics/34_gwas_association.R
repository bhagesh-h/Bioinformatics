#' ---
#' title: "Applied 34 - Genotypes, GWAS, and statistical genetics"
...
cat("  confounder (Module 22, fork structure).\n")
...
#'
#' **Next:** `35_proteomics_missing_values.R`
