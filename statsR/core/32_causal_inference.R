#' ---
#' title: "Module 32 - Causal inference for observational bioinformatics"
...
cat("  cell composition?' (Module 23). But the product-of-coefficients\n")
...
#'
#' **Next:** `33_bayesian_and_shrinkage.R`
