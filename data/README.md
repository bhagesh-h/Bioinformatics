...
### 20: Bulk RNA-seq differential expression
...
a dexamethasone-treated sample. This is exactly the structure module 20
...
se <- airway
se$dex <- relevel(se$dex, "untrt")   # set the reference level EXPLICITLY (Module 20)
...
setting of module 21: the cells are not replicates, the patients are.
...
### 22: Cytometry differential abundance
...
of the traps module 22 is about.
...
Population structure is the whole lesson of module 24, and 1000 Genomes has
...
### 25: Proteomics and missing values
...
is what makes the missingness MNAR, and it is why module 25 warns against
...
is module 27's entire lesson: thousands of spots, but three independent
biological units.

### 28b: Survival with biomarkers
...
makes GO output so hard to interpret (module 29, section 8).

### 30: Networks and multi-omics

**TCGA multi-assay** via `curatedTCGAData`, which returns a
`MultiAssayExperiment` - the structure module 30 simulates. The **CLL
